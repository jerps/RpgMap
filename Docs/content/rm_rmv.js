...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Remove the key/item pair with key equal to <code>key</code> from <code>map</code>, if \
found, and return <code>map</code>. If not found do nothing, and return <code>map</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;If the key and/or item is a value or an automatically disposed map \
then they\'re disposed.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;In case there are multiple keys equal to <code>key</code> then <code>opt</code> indicates \
...
<span class="bullet1">&sstarf;</span>&nbsp;This procedure disposes <code>key</code> automatically, unless <code>key</code> is a manually \
