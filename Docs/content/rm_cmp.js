...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Compare <code>obj1</code> with <code>obj2</code>. They can be <code>*null</code>, a value or a map.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Return <code>-1</code> if <code>obj1</code> is less than <code>obj2</code>, return <code>1</code> if <code>obj1</code> is \
greater than <code>obj2</code>, return <code>0</code> if <code>obj1</code> and <code>obj2</code> are equal.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Two <code>*null</code>s are considered equal.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;This is the default compare function for maps. The compare function \
...
<span class="bullet1">&sstarf;</span>&nbsp;Two objects have a natural ordering when they are of the same kind:<br>\
...
&nbsp;&nbsp;- maps.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;If the objects don\'t have a natural order then they are ordered \
based on their type as follows:<br>\
</p>\
<pre>    <code>*null</code> < n < i < p < t < d < z < x < xp < a < aa < s < sa < m/v </pre>\
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Two maps are equal if they both have the exact same keys and items, \
in the same order.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;The attributes of maps (<a href="#rm_sav"><code>rm_sav</code></a>) are ignored when doing comparisons \
between maps.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;When two maps or a map and a vector are compared, then first the keys \
...
<span class="bullet1">&sstarf;</span>&nbsp;When two vectors (maps created with <a href="#rm_v"><code>rm_v</code></a>) are compared the comparison \
...
composite keys.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;When either one of <code>obj1</code> or <code>obj2</code> has the reversed order special \
...
<span class="bullet1">&sstarf;</span>&nbsp;When either one of <code>obj1</code> or <code>obj2</code> has the "case insensitive order" \
...
<span class="bullet1">&sstarf;</span>&nbsp;Character data and strings (char data in utf-8 format) can have the \
...
<span class="bullet1">&sstarf;</span>&nbsp;Strings must be converted first to the job CCSID before they can be \
