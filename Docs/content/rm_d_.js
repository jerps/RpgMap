...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;Return an RPG <code>date</code> from <code>value</code>, which must be a date or timestamp.<br>\
...
<span class="bullet1">&#8407;</span>&nbsp;A timestamp is converted to a date using BIF %date.\
</p>\
\
');
