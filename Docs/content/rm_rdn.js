...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Call <a href="#rm_rdn"><code>rm_rdn</code></a> to read the next key/item pair for cursor <code>cur</code>, or \
...
<span class="bullet1">&sstarf;</span>&nbsp;Return <code>*on</code> if there was a next or previous key/item. Return <code>*off</code> if \
the cursor is at the end or the beginning, in which case there is no current key/item anymore.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Key/item pairs can be removed while a cursor iterates over them. \
...
<span class="bullet1">&sstarf;</span>&nbsp;If <code>key1</code> and/or <code>key2</code> are passed then the next or previous key must be \
