...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Add event handler <code>hproc</code> to the list of event handlers registered \
for <code>map</code>, and return <code>map</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Events are fired when key/item pairs are inserted into and removed \
...
first).<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Procedure <code>hproc</code> must have the following signature:\
</p>\
<pre class="procsig">\
  rtn type: int(10)<br>\
...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Parameter <code>event</code> is <code>1</code> when the "inserted" event has been triggered \
...
<span class="bullet1">&sstarf;</span>&nbsp;Parameters <code>key</code> and <code>item</code> is the key/item pair that has been inserted, \
...
disposed maps).<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Parameter <code>map</code> is the map where the event was fired, <code>usrd</code> is the \
...
<span class="bullet1">&sstarf;</span>&nbsp;The handler\'s return value is ignored.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;If the same handler is added multiple times it will be called as many \
times as it was added.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Event handlers are removed with procedure <a href="#rm_remove_event_handler"><code>rm_remove_event_handler</code></a>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;If a map is disposed then no event handlers will be called. Use <a href="#rm_rmva"><code>rm_rmva</code></a> \
