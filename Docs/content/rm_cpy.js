...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;Return a (shallow) copy of <code>obj</code>, which must be a map or a value.<br>\
<span class="bullet1">&#8407;</span>&nbsp;The new map or value has the same properties and attributes as <code>obj</code> \
...
<span class="bullet1">&#8407;</span>&nbsp;Event handlers are NOT copied; the copy has no event handlers.<br>\
<span class="bullet1">&#8407;</span>&nbsp;Return <code>*null</code> if <code>obj</code> is <code>*null</code>.<br>\
<span class="bullet1">&#8407;</span>&nbsp;Use <a href="#rm_cpyd"><code>rm_cpyd</code></a> to make a deep copy of a map, \
in which case manually disposed maps are also (deep) copied.<br>\
<span class="bullet1">&#8407;</span>&nbsp;Be aware that when manually disposed maps are not used then <a href="#rm_cpy"><code>rm_cpy</code></a> \
...
<span class="bullet1">&#8407;</span>&nbsp;If <code>key1</code> and/or <code>key2</code> are passed and not <code>*null</code> the copy will only \
...
<span class="bullet1">&#8407;</span>&nbsp;Ignore <code>key1</code>/<code>key2</code> if <code>obj</code> is a value.<br>\
<span class="bullet1">&#8407;</span>&nbsp;An alternative way to copy for example an integer value: <code>rm_i(rm_i_(val))</code>.<br>\
