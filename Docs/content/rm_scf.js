...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;Set the compare function of <code>map</code>, which must be empty, to <code>comp</code>, \
and return <code>map</code>. Send escape messsage RM00041 if <code>map</code> is not empty.<br>\
<span class="bullet1">&#8407;</span>&nbsp;The compare function of <code>map</code> determines how the keys in <code>map</code> are \
...
compare function.<br>\
<span class="bullet1">&#8407;</span>&nbsp;Procedure <code>comp</code> must have the following signature:\
</p>\
<pre class="procsig">\
  rtn type: int(10)<br>\
...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;Procedure <code>comp</code> compares <code>obj1</code> and <code>obj2</code>, which can be <code>*null</code> or \
...
<span class="bullet1">&#8407;</span>&nbsp;If <code>comp</code> returns something else than <code>0</code>, <code>1</code> or <code>-1</code> then the comparison \
falls back to <a href="#rm_cmp"><code>rm_cmp</code></a>.<br>\
<span class="bullet1">&#8407;</span>&nbsp;If <code>comp</code> is <code>*null</code> then <a href="#rm_cmp"><code>rm_cmp</code></a> is reset to be used as the compare \
function again.<br>\
<span class="bullet1">&#8407;</span>&nbsp;The following is a simple example of a <code>comp</code> procedure body, which \
