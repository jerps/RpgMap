...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;Like <a href="#rm_get"><code>rm_get</code></a>, but procedures <code>rm__??</code> retrieve an item using one or more \
...
<span class="bullet1">&#8407;</span>&nbsp;When multiple keys are given the item is retrieved through one or more \
nested maps.<br>\
<span class="bullet1">&#8407;</span>&nbsp;First the item in <code>map</code> with key equal to the first passed key is retrieved. \
...
<span class="bullet1">&#8407;</span>&nbsp;Up to 10 keys can be passed. Parameters <code>k01</code> through <code>k10</code> are all \
optional. If none are passed then <code>*null</code> is returned. Keys that are <code>*null</code> \
are ignored.<br>\
<span class="bullet1">&#8407;</span>&nbsp;Use procedure <a href="#rm__"><code>rm__</code></a> as a generic procedure which accepts keys of any type. \
