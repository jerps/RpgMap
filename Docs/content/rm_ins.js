document.write('\
\
<div id="rm_ins"><div class="prochdr1">rm_ins</div><div class="prochdr2">&nbsp;&nbsp;<pre class="prochsep">&#10072;</pre>&nbsp;&nbsp;Insert key/item pairs</div></div>\
...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Insert up to 100 new key/item pairs into <code>map</code> and return <code>map</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;The keys and items must be maps or values. Values are automatically \
...
<span class="bullet1">&sstarf;</span>&nbsp;A key/item pair is inserted into a specific slot, depending on the \
...
properties.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Values and maps that are automatically disposed can only be inserted \
...
<span class="bullet1">&sstarf;</span>&nbsp;Keys can not be <code>*null</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Items can be <code>*null</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;A map is allowed to contain duplicate keys (i.e. keys that are equal). \
...
be avoided.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Starting at the second argument, every even and uneven argument corresponds \
to a key/item pair that is to be inserted. Pairs where the key is <code>*null</code> \
are ignored.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Items which were not inserted (because no key was specified) will be \
