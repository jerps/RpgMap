...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Like <a href="#rm_ins"><code>rm_ins</code></a>, but a key/item pair is only inserted if there is \
no key in <code>map</code> that is equal to the key to be inserted.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Keys and items that are not inserted are disposed automatically, \
