...
<p>\
Download <a href="https://github.com/jerps/RpgMap/releases/download/1.1.0/RpgMap-1.1.0.zip">RpgMap-1.1.0.zip</a> and put it somewhere on the IFS, e.g. /home/...<br>\
If you didn\'t already, start QSH (QSHELL, not PASE).<br>\
Cd into the directory with the zip file.<br>\
Unzip the file with <code>jar xvf RpgMap-1.1.0.zip</code>.<br>\
