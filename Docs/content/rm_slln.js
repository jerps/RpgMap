...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;This procedure combines <a href="#rm_sll"><code>rm_sll</code></a> and <a href="#rm_rdn"><code>rm_rdn</code></a> into one, so that \
...
<span class="bullet1">&#8407;</span>&nbsp;Each time <a href="#rm_slln"><code>rm_slln</code></a> is called: 1. if <code>pos</code> is <code>*on</code> the cursor is \
...
<span class="bullet1">&#8407;</span>&nbsp;When doing a read-equal (i.e. when specifying only <code>key1</code> for <a href="#rm_rdn"><code>rm_rdn</code></a> \
...
<span class="bullet1">&#8407;</span>&nbsp;Parameter <code>key1</code> is passed as argument <code>key</code> to <a href="#rm_sll"><code>rm_sll</code></a> and <code>key1</code> \
...
<span class="bullet1">&#8407;</span>&nbsp;The following code loops through all keys equal to <code>d\'2017-01-01\'</code>.\
</p>\
<pre class="pcode">\
pos = *on;<br>\
