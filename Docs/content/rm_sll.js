...
<p>\
<span class="bullet1">&#8407;</span>&nbsp;Position cursor <code>cur</code> on <code>key</code> and return <code>cur</code>.<br> \
<span class="bullet1">&#8407;</span>&nbsp;Call <a href="#rm_sll"><code>rm_sll</code></a> to position the cursor just before the lowest key that is equal \
...
<span class="bullet1">&#8407;</span>&nbsp;After calling this procedure cursor <code>cur</code> has no current key/item pair.<br>\
<span class="bullet1">&#8407;</span>&nbsp;Call <a href="#rm_rdn"><code>rm_rdn</code></a> or <a href="#rm_rdp"><code>rm_rdp</code></a> to read the next or previous key/item pair, resp., \
which then ecomes the current key/value pair.<br>\
<span class="bullet1">&#8407;</span>&nbsp;If <a href="#rm_sll"><code>rm_sll</code></a> is called and the next key/item pair is removed from the map the \
...
<span class="bullet1">&#8407;</span>&nbsp;If <a href="#rm_sll"><code>rm_sll</code></a> is called and there is no key equal to or greater, or if <a href="#rm_sgt"><code>rm_sgt</code></a> \
is called and there is no key equal to or less, the cursor is positioned at the end or beginning resp.<br>\
<span class="bullet1">&#8407;</span>&nbsp;These procedures dispose <code>key</code> automatically, unless <code>key</code> is a manually \
