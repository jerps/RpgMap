...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Position cursor <code>cur</code> on <code>key</code> and return <code>cur</code>.<br> \
<span class="bullet1">&sstarf;</span>&nbsp;Call <a href="#rm_sll"><code>rm_sll</code></a> to position the cursor just before the lowest key that is equal \
...
<span class="bullet1">&sstarf;</span>&nbsp;After calling one of these procedures cursor <code>cur</code> has no current key/item pair.<br>\
...
<span class="bullet1">&sstarf;</span>&nbsp;If <a href="#rm_sll"><code>rm_sll</code></a> is called and there is no key equal to or greater, or if <a href="#rm_sgt"><code>rm_sgt</code></a> \
is called and there is no key equal to or less, the cursor is positioned at the end or beginning resp.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;These procedures dispose <code>key</code> automatically, unless <code>key</code> is a manually \
