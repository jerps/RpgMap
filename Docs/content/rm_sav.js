...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Set up to 100 attributes of <code>map</code> to a value and return <code>map</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Each map can have one or more attributes set to a value, where \
...
<span class="bullet1">&sstarf;</span>&nbsp;The first attribute name and value is passed with parameters 2 and 3, \
<code>a001</code> and <code>v001</code>, the second with <code>a002</code> and <code>v002</code>, etc.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Send escape message RM00102 if an attribute name is blank or empty.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;If a value is not passed or it is blank or empty then the attribute \
is "unset".<br>\
<span class="bullet1">&sstarf;</span>&nbsp;If no attribute names or values are passed at all (i.e. only <code>map</code> \
is passed) then every attribute of <code>map</code> is unset (all are cleared).<br>\
<span class="bullet1">&sstarf;</span>&nbsp;Attributes are used to store settings and meta data that is used \
...
<span class="bullet1">&sstarf;</span>&nbsp;Attribute names starting with "_" (underscore) should not be used \
