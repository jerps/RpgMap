...
<span class="bullet1">&#8407;</span>&nbsp;Send escape message RM00102 if an attribute name is blank or empty.<br>\
<span class="bullet1">&#8407;</span>&nbsp;If a value is not passed or it is blank or empty then the attribute \
is "unset".<br>\
<span class="bullet1">&#8407;</span>&nbsp;If no attribute names or values are passed at all (i.e. only <code>map</code> \
is passed) then every attribute of <code>map</code> is unset (all are cleared).<br>\
<span class="bullet1">&#8407;</span>&nbsp;Attributes are used to store settings and meta data that is used \
...
<span class="bullet1">&#8407;</span>&nbsp;Attribute names starting with "_" (underscore) should not be used \
