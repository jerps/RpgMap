...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Like <a href="#rm_ins"><code>rm_ins</code></a>, but the key/item pairs to insert are contained in <code>map2</code>.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;The values and automatically disposed maps in <code>map2</code> that are to be \
...
<span class="bullet1">&sstarf;</span>&nbsp;If <code>key1</code> and/or <code>key2</code> are passed and not <code>*null</code> then only the key/item \
...
in a map.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;This procedure does not dispose <code>map2</code> or it\'s keys/items.\
</p>\
\
');
