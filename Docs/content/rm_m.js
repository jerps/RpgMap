document.write('\
\
<div id="rm_m"><div class="prochdr1">rm_m</div><div class="prochdr2"> - Create a new map, automatically disposed</div></div>\
<pre class="procsig">\
&lt;&lt;pointer<br>\
...
<p>\
Create a new map and return a pointer to it.<br>\
The map should be disposed - with <a href="#rm_dis"><code>rm_dis</code></a> \
