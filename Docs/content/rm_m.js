...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Create a new map and return a pointer to it.<br>\
<span class="bullet1">&sstarf;</span>&nbsp;The map should be disposed - with <a href="#rm_dis"><code>rm_dis</code></a> \
...
<span class="bullet1">&sstarf;</span>&nbsp;Like a value, an automatically disposed map can be inserted into \
...
<span class="bullet1">&sstarf;</span>&nbsp;The new map can be immediately populated with key/item pairs by passing \
