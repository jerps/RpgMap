document.write('\
\
<div id="rm_hit"><div class="prochdr1">rm_hit</div><div class="prochdr2"> - Has item?</div></div>\
...
<p>\
Return <code>*on</code> if <code>map</code> has an item that is equal to <code>item</code>, else return <code>*off</code>.<br>\
