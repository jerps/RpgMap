document.write('\
\
<div id="rm_aa"><div class="prochdr1">rm_aa</div><div class="prochdr2">&nbsp;&nbsp;<pre class="prochsep">&#10072;</pre>&nbsp;&nbsp;Create a new character data value, alt. sort sequence</div></div>\
<pre class="procsig">\
&lt;&lt;pointer<br>\
...
<p>\
<span class="bullet1">&sstarf;</span>&nbsp;Like <a href="#rm_a"><code>rm_a</code></a>, but the character data is compared using an alternate sort \
...
<span class="bullet1">&sstarf;</span>&nbsp;Comparing data using an alternate sort sequence may take more resources than \
