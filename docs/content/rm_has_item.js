document.write('\
\
<div id="rm_has_item"><div class="prochdr1">rm_has_item</div><div class="prochdr2">&nbsp;&nbsp;<pre class="prochsep">&#10072;</pre>&nbsp;&nbsp;Has item?</div></div>\
<pre class="procsig">\
&lt;&lt;ind<br>\
...
<p>\
<span class="bullet1">&#9679;</span>&nbsp;Return <code>*on</code> if <code>map</code> has an item that is equal to <code>item</code>, else return <code>*off</code>.<br>\
