document.write('\
\
<div id="rm_sa"><div class="prochdr1">rm_sa</div><div class="prochdr2">&nbsp;&nbsp;<pre class="prochsep">&#10072;</pre>&nbsp;&nbsp;Create new string value, alt. sort sequence</div></div>\
<pre class="procsig">\
&lt;&lt;pointer<br>\
...
<p>\
<span class="bullet1">&#9679;</span>&nbsp;Like <a href="#rm_s"><code>rm_s</code></a>, but the string is compared using an alternate sort sequence. \
...
<span class="bullet1">&#9679;</span>&nbsp;Comparing strings using the alternate sort sequence takes considerably \
