document.write('\
\
<div id="rm_copy"><div class="prochdr1">rm_copy</div><div class="prochdr2">&nbsp;&nbsp;<pre class="prochsep">&#10072;</pre>&nbsp;&nbsp;Copy map or value</div></div>\
<pre class="procsig">\
&lt;&lt;pointer<br>\
...
<p>\
<span class="bullet1">&#9679;</span>&nbsp;Return a (shallow) copy of <code>obj</code>, which must be a map or a value.<br>\
<span class="bullet1">&#9679;</span>&nbsp;The new map or value has the same properties and attributes as <code>obj</code>, \
...
<span class="bullet1">&#9679;</span>&nbsp;Event handlers are NOT copied; the copy has no event handlers.<br>\
<span class="bullet1">&#9679;</span>&nbsp;Return <code>*null</code> if <code>obj</code> is <code>*null</code>.<br>\
<span class="bullet1">&#9679;</span>&nbsp;Use <a href="#rm_copy_deep"><code>rm_copy_deep</code></a> to make a deep copy of a map, \
in which case manually disposed maps are also (deep) copied.<br>\
<span class="bullet1">&#9679;</span>&nbsp;The new copy is always mutable. Maps contained in <code>obj</code> that are \
immutable stay immutable and copies of these maps that are included in the copy are also immutable.<br>\
<span class="bullet1">&#9679;</span>&nbsp;Be aware that when manually disposed maps are not used then <a href="#rm_copy"><code>rm_copy</code></a> \
and <a href="#rm_copy_deep"><code>rm_copy_deep</code></a> have the same effect, i.e. contained maps are copied \
...
disposed maps then <a href="#rm_copy"><code>rm_copy</code></a> will produce a real shallow copy.<br>\
<span class="bullet1">&#9679;</span>&nbsp;If <code>key1</code> and/or <code>key2</code> are passed and not <code>*null</code> the copy will only \
...
<span class="bullet1">&#9679;</span>&nbsp;Ignore <code>key1</code>/<code>key2</code> if <code>obj</code> is a value.<br>\
<span class="bullet1">&#9679;</span>&nbsp;An alternative way to copy for example an integer value: <code>rm_i(rm_i_(val))</code>.<br>\
