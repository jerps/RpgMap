document.write('\
\
<div id="rm_read_next"><div class="prochdr1">rm_read_next</div><div class="prochdr2">&nbsp;&nbsp;<pre class="prochsep">&#10072;</pre>&nbsp;&nbsp;Read next key/item pair</div></div>\
<pre class="procsig">\
&lt;&lt;ind<br>\
...
<p>\
<span class="bullet1">&#9679;</span>&nbsp;Call <a href="#rm_read_next"><code>rm_read_next</code></a> to read the next key/item pair for cursor <code>cur</code>, or \
call <a href="#rm_read_prev"><code>rm_read_prev</code></a> to read the previous key/item pair. The next/previous \
pair becomes the current key/item pair. Procedures <a href="#rm_key"><code>rm_key</code></a> and \
<a href="#rm_item"><code>rm_item</code></a> are used to read the current key or item, resp.<br>\
...
current key/item pair anymore, and <a href="#rm_key"><code>rm_key</code></a> and <a href="#rm_item"><code>rm_item</code></a> will return \
<code>*null</code>. If <a href="#rm_read_next"><code>rm_read_next</code></a> was used to read the current key/item the cursor is \
positioned just before the key/item pair that comes after the removed \
key/item. If <a href="#rm_read_prev"><code>rm_read_prev</code></a> was used the cursor is positioned just after the \
key/item pair that comes before the removed key/item. Procedures <a href="#rm_read_next"><code>rm_read_next</code></a> \
and <a href="#rm_read_prev"><code>rm_read_prev</code></a> must be used to get a current key/item pair again. The cursor \
